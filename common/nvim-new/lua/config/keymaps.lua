...
-- Diagnostic keymaps
vim.keymap.set("n", "<leader>q", "<cmd>Trouble qflist toggle<cr>", { desc = "[Q]uickfix list" })
...
-- vim.keymap.set("n", "<Esc><Esc>", vim.cmd("q"), { desc = "Exit" })
-- vim.keymap.set("v", "<Esc><Esc>", vim.cmd("q"), { desc = "Exit" })
