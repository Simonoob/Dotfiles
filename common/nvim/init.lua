...
require('lazy').setup({
  ...
  -- options to `iff.nvim`. This is equivalent to the following Lua:
  ...
  { -- Useful plugin to show you pending keybinds.
    ...
    config = function() -- This is the function that runs, AFTER loading
      ...
      require('which-key').register {
        ...
        ['<leader>ggo'] = { name = '[O]pen', _ = 'which_key_ignore' },
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      require('which-key').register {
        ['<leader>sg'] = { name = '[S]earch by [G]rep', _ = 'which_key_ignore' },
      }
      ...
      vim.keymap.set('n', '<leader>sgs', builtin.live_grep, { desc = '[S]tring' })
      vim.keymap.set('n', '<leader>sga', require('telescope').extensions.live_grep_args.live_grep_args, { desc = '[A]rguments' })
      ...
      end, { desc = '[S]earch [C]urrent buffer fuzzly' })

      -- Hide buffer search
      vim.keymap.set('n', '<leader>sh', function()
        vim.cmd 'nohlsearch'
      end, { desc = '[S]earch [H]ide highlights' })
...

  {
    ...
    opts = {
      ...
      formatters_by_ft = {
        ...
        php = { { 'blade-formatter', 'php_cs_fixer', 'pretty-php' } },
    ...
    config = function()
      ...
      cmp.setup {
        ...
        mapping = cmp.mapping.preset.insert {
          ...
          -- NOTE: might change this later to the default mappings
          --
